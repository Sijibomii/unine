      ...
      <div className='py-4 px-8 mt-6'>
        ...
        <div className='flex flex-col justify-center bg-[#FFF] mt-10 px-6 py-8 rounded-2xl'>
          ...
          <div className='bottom mt-14'>
            <h4 className='b text-xl font-bold'>No hidden fees</h4>
            <p className='calmer-white mt-4 text-md mt-8'>You will only be charged for selling goods or requesting payment</p>
          </div>
        </div>
        ...
        <div className='flex flex-col justify-center bg-[#FFF] mt-10 px-6 py-8 rounded-2xl'>
          ...
          <div className='bottom mt-14'>
            <h4 className='b text-xl font-bold'>Free Shipping</h4>
            <p className='calmer-white mt-4 text-md mt-8'>Changed your mind after buying? Send back the item you purchased</p>
          </div>
        </div>
