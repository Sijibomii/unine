  ...
  return (
    <div className='px-2 pt-16 pb-10 bg-[#F8F8F8]'>
      ...
      <div className='py-4 px-12 mt-6'>
        <div className='flex flex-col justify-center bg-[#FFF] px-6 py-4 rounded-2xl'>
          <div className='top'>
        ...
        <div className='flex flex-col justify-center bg-[#72E484] mt-10 px-6 py-4 rounded-2xl'>
